...
namespace App1
{
    ...
    {
        // For POC it's harcoded. TODO: put in external resource.
        const string subscriptionKey = "Your cognitive service subsription key here";
        ...
        public static async Task<string> MakeAnalysisRequest(string imageFilePath)
        {
            ...
            using (ByteArrayContent content = new ByteArrayContent(byteData))
            {
                ...
                return GetCaption(contentString);
            }
        }
        ...
        static string GetCaption(string json)
        {
